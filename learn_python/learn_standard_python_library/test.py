...
print(math.ceil(num_float)) # ceil gives the rounded up value
print(math.floor(num_float)) # floor gives the rounded down value
print(math.pi) # gives the value for pi


# 5 can't go into 1, so the remainder is 1
print(f"Remainder from 1/5: {math.remainder(1, 5)}") # gives us the remainder of 2 values
